...
/*
 ...
 Description:	This plugin allows you to easily add your Picasa photos to your posts or pages.
 Author: ESPR!T
 Version: 0.0.5
...
function wpEspritPicasaAddMediaButton() {
  ...
  $media_picasa_iframe_src = apply_filters('media_picasa_iframe_src', "$media_upload_iframe_src&amp;type=picasa&amp;tab=photo");
...
add_action('media_upload_photo', 'wpEspritPicasaMediaUpload');
add_action('save_post','wpEspritPicasaSaveMetadata');

if (get_option(WpEspritPicasa::$WP_OPTION_PEREX_STATUS)=='on') {
  add_action('media_upload_thumbnail', 'wpEspritPicasaMediaUpload');
